...
<div class="hing-content">
  ...
  <ul>
    <li>Overview <a href='/other-topics/files/garden/garden-overview.pdf'>Fact Sheet</a>  (UC Davis and U Maryland)</li>
    <li>Getting Started <a href='/other-topics/files/garden/getting-started.pdf'>Fact Sheet</a>  (UC Davis and U Maryland))</li>
    <li>Simple Kitchen Garden Checklist <a href='/other-topics/files/garden/garden-checklist.pdf'>Info Sheet</a>  (U Maryland)</li>
    <li>Decision Matrix for Garden Site Selection <a href='/other-topics/files/garden/matrix-garden-site.pdf'>PPT as PDF</a>  (U Maryland)</li>
    </ul>
  </div>
  <div class="hing-content">
    ...
    <ul>
      ...
      <ul>
        <li>Different Types <a href='/other-topics/files/garden/growing-media.pdf'>Fact Sheet</a> </li>
        <li>Common Mixes <a href='/other-topics/files/garden/growing-media-mixes.pdf'>Fact Sheet</a> </li>
        <li>Media Management <a href='/other-topics/files/garden/management-considerations.pdf'>Fact Sheet</a> </li>
        <li>Peat Moss <a href='/other-topics/files/garden/peat-moss.pdf'>Fact Sheet</a> </li>
        <li>Peat and Lime Requirements <a href='/other-topics/files/garden/peat-lime-requirement.pdf'>Fact Sheet</a> </li>
      </ul>
      <li>More Information on Soil Webpage</li>
      </ul>
    </div>
  <div class="hing-content">
    <h2>Planting</h2>
  ...
  <div class="hing-content">
    <h2>Seed Saving</h2>
    <ul>
      <li>Importance of Seed Quality <a href='/other-topics/files/garden/seed-quality.pdf'>Info Sheet</a>  (UC Davis)</li>
      <li>Saving Your Own Seed <a href='/other-topics/files/garden/save-vegetable-seeds.pdf'>Manual</a>  (1.4 MB) (AVDRC)</li>
    </ul>
  </div>
<div class="hing-content">

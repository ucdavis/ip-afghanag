...
def main():
	...
	for names in listNames:
		if "pdf" in names.get('href') or ".doc" in names.get('href') or ".ppt" in names.get('href') or "fact" in names.get('href') or "sheet" in names.get('href') or '.pub' in names.get('href'):
			#print names
		  	link = names.get('href')
			print link
